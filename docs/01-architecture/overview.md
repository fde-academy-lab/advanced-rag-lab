...
> **Audience:** anyone about to change `raglab/`, and anyone who wants to explain this system
...
`raglab.bedrock.LOCAL_TO_AWS` holds this mapping in code so it stays honest.
